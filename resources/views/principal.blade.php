        ...
        <div class="row">
            <div class="col-md-8">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link shadow" data-toggle="tab" href="#profile" style="color: #1c7430">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link shadow" data-toggle="tab" href="#other" style="color: #1c7430">Other</a>
                    </li>
                </ul>
                <br>
                <div id="myTabContent" class="tab-content" style="color: #1c7430">
                    <div class="tab-pane fade active show" id="home">
                        <p class="text-success">Raw denim you probably haven't heard of them jean shorts Austin 3:16</p>
                        <p class="text-success">Nesciunt tofu stumptown aliqua, retro synth master cleanse. dev deploy</p>
                        <p class="text-success">Mustache cliche tempor, williamsburg carles vegan helvetica.</p>
